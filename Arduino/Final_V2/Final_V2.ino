...
void loop() {
  ...
  if (regado && (hoy_regar && (Hora_now == Hora_final_m && Minu_now == Minuto_final_m) || (Hora_now == Hora_final_a && Minu_now == Minuto_final_a)) &&  !regar) {
