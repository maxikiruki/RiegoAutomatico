...
/////////////////CONSULTA ID HORARIO DEL SECTOR 1//////////////////////////////  
  ...
  // Asocio las columnas, pero no las uso
...
/////////////////COMPRUEBO SI EL SECTOR 1 ESTA PROGRAMADO Y/O MANUAL //////////////////////////////
  ...
  cur_mem2->execute("SELECT * FROM riegoautomatico.state WHERE sector_id=1;");
