...
void loop() {
  ...
  */
  ...
  /*
    if (regado) {
    Serial.println("Entra if regar && regado  linea 328");
    delay(2000);
  ...
  */
  ...
  if (regado &&  !regar) {
    ...
    //VALUES (NULL, '1', '2020-05-24', '18:24:00', '18:30:00', '10', '75', '80');
    //char insert_sector1[] = "INSERT INTO history.riegoautomatico (sector_id, date,start_time,end_time,start_humidity,final_humidity,total_liters) VALUES ('Hello, Arduino!')";


    String insert_sector0 = "INSERT INTO history.riegoautomatico (sector_id, date,start_time,end_time,start_humidity,final_humidity,total_liters) VALUES (1,'" + fecha + "','" + time_init + "','" + time_final + "','" + Humedad_init + "','" + Humedad_final + "','" + TotalLitros + "');";
    
    Serial.println(insert_sector1);
    MySQL_Cursor *cur_mem3 = new MySQL_Cursor(&conn);
    cur_mem3->execute(insert_sector1);
    delete cur_mem3;
