...
void loop() {
  ...
  */
  ...
  if (regado &&  !regar) {
    ...
    char insert_sector1[] = "INSERT INTO history.riegoautomatico (sector_id, date,start_time,end_time,start_humidity,final_humidity,total_liters) VALUES  ('1','%s','%s',%d,%d,%d)";
    char query[128];
